...
% modified 12/11/2009 - RB
    ...
    alpha_c     = 180/pi*uu(23);     % commanded angle of attack (deg)
    beta_c      = 180/pi*uu(24);     % commanded side slip angle (deg)
    phi_c       = 180/pi*uu(25);     % commanded roll angle (deg)   
    theta_c     = 180/pi*uu(26);     % commanded pitch angle (deg)
    chi_c       = 180/pi*uu(27);     % commanded course (deg)
