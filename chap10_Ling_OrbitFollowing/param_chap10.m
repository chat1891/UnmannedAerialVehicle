...
% Wind conditions
P.w_mag = -2; % Wind speed at 6 m altitude (m/s)
...
P.sigma_accel = 0.0025*9.8*10; % standard deviation of accelerometers in m/s^2
...
%% Chapter 9 - Guidance Model parameters
...
P.b_h = wn_h^2;
%% Chapter 10 - Path Following parameters
P.chi_infty = 30*pi/180;  % approach angle for large distance from straight-line path
P.k_path    = 0.5;        % proportional gain for path following
P.k_orbit   = 0.01;       % proportional gain for orbit following
