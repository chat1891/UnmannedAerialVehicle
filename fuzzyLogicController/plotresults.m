...
%         subplot(8,2,1)
%         hold on
%         pnpe_handle = graph_y_yhat_yd(t, pn, pn_hat, pn_c, 'p_n', []);
        
       
        subplot(3,1,1)
        hold on
        pnpe_handle = graph_y(pn, h, [], 'b');
        ylabel('h')
        xlabel('pn')
...
function handle = graph_y_yd_xlabel(t, y, yd, lab,labx, handle)
