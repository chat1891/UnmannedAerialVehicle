...
%% Scalar formulation of kinematics and dynamics equations
    ...
    gamma6 = P.Jxz/P.Jy;
    gamma7 = (P.Jx*(P.Jx-P.Jy)+P.Jxz^2)/gamma;
    gamma8 = P.Jx/gamma;
...
%     Posdot = % Posdot is the column matrix of position time derivatives
%     Vb_gdot = 
%     Psidot = % Psidot is the column matrix of Euler angle time derivatives
%     wb_idot = 
%     
