...
function dubinspath = dubinsParameters(start_node, end_node, R)
  ...
  if ell<2*R
    ...
    crs = ps'+R*[cos(chis+pi/2);sin(chis+2/pi);0];
    cls = ps'+R*[cos(chis-pi/2);sin(chis-2/pi);0];
    cre = pe'+R*[cos(chis+pi/2);sin(chis+2/pi);0];
    cle = pe'+R*[cos(chis-pi/2);sin(chis-2/pi);0];
